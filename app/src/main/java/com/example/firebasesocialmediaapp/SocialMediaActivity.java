...
public class SocialMediaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    //when the back button is pressed it will perform a particular task
    @Override
    ...
    private void transitionToSignUpPage(){
        mAuth.signOut();
    ...
    private void uploadImageToServer() {
        ...
        if (bitmap != null) {
            ...
            imageIdentifier = UUID.randomUUID() + ".png"; // create unique values
